...
# plot inflation surprise γ * (x_e - x_r)
γ_μ_1_ω_1 = BP.γ .* (x_e.(ω_1_res[:, 6], BP.x_T, BP.ν_1, BP.ν_2) .- x_r(1, BP.x_T, BP.ν_1, BP.ν_2))
γ_μ_1_ω_2 = BP.γ .* (x_e.(ω_1_res[:, 6], BP.x_T, BP.ν_1, BP.ν_2) .- x_r(2, BP.x_T, BP.ν_1, BP.ν_2))
γ_μ_2_ω_1 = BP.γ .* (x_e.(ω_1_res[:, 7], BP.x_T, BP.ν_1, BP.ν_2) .- x_r(1, BP.x_T, BP.ν_1, BP.ν_2))
γ_μ_2_ω_2 = BP.γ .* (x_e.(ω_1_res[:, 7], BP.x_T, BP.ν_1, BP.ν_2) .- x_r(2, BP.x_T, BP.ν_1, BP.ν_2))
fig = Figure(fontsize=32, size=(600, 500))
ax = Axis(fig[1, 1], xlabel=L"Unemployment shock $\omega_1$")
...
# plot inflation surprise γ * (x_e - x_r)
γ_μ_1_ω_2 = BP.γ .* (x_e.(ω_2_res[:, 6], BP.x_T, BP.ν_1, BP.ν_2) .- x_r(1, BP.x_T, BP.ν_1, BP.ν_2))
γ_μ_1_ω_2 = BP.γ .* (x_e.(ω_2_res[:, 6], BP.x_T, BP.ν_1, BP.ν_2) .- x_r(2, BP.x_T, BP.ν_1, BP.ν_2))
γ_μ_2_ω_2 = BP.γ .* (x_e.(ω_2_res[:, 7], BP.x_T, BP.ν_1, BP.ν_2) .- x_r(1, BP.x_T, BP.ν_1, BP.ν_2))
γ_μ_2_ω_2 = BP.γ .* (x_e.(ω_2_res[:, 7], BP.x_T, BP.ν_1, BP.ν_2) .- x_r(2, BP.x_T, BP.ν_1, BP.ν_2))
fig = Figure(fontsize=32, size=(600, 500))
ax = Axis(fig[1, 1], xlabel=L"Unemployment shock $\omega_2$")
